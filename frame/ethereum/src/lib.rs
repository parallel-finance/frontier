...
impl<T: Config> Pallet<T> {
	...
	// migrate_block_v2 is not used in any place.
	// Since `OnRuntimeUpgradeHelpersExt` is deprecated with this PR (https://github.com/paritytech/substrate/pull/12185),
	// set_temp_storage and get_temp_storage is no more supported.
